...
//
//    @Bean
//    public HeadersExchange topicExchange(){
...
//        map.put("color","red");
//        map.put("speed","low");
//        return BindingBuilder.bind(queue01()).to(topicExchange()).whereAny(map).match();
//    }
//
//    @Bean
...
//        map.put("speed","fast");
//        //全部匹配上，才能转发到队列
//        return BindingBuilder.bind(queue01()).to(topicExchange()).whereAll(map).match();
//    }
//
//
//}
